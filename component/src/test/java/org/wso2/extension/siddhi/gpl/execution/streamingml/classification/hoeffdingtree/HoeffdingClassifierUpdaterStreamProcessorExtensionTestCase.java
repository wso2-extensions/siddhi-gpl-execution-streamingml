...
public class HoeffdingClassifierUpdaterStreamProcessorExtensionTestCase {
    ...
    public void testHoeffdingClassifierLearningExtension3() throws InterruptedException {
        ...
        try {
            ...
            AssertJUnit.assertTrue(e.getCause().getMessage().contains("6th parameter is not an double type attribute. "
    ...
    public void testHoeffdingClassifierLearningExtension7() throws InterruptedException {
        ...
        try {
            ...
            logger.error(e.getCause().getMessage());
            AssertJUnit.assertTrue(e instanceof SiddhiAppCreationException);
            AssertJUnit.assertTrue(e.getCause().getMessage().contains("Number of classes must be "
                    + "(ConstantExpressionExecutor) but found io.siddhi.core.executor."
    ...
    public void testHoeffdingClassifierLearningExtension9() throws InterruptedException {
        ...
        try {
            ...
            AssertJUnit.assertTrue(e.getCause().getMessage().contains("Number of hyper-parameters needed for "
                    + "model manual configuration is 7 but found 1"));
        }
    }
    ...
    public void testHoeffdingClassifierLearningExtension11() throws InterruptedException {
        ...
        String query = ("@info(name = 'query1') "
                + "from StreamA#streamingml:updateHoeffdingTree('model1', 3, 5, 200, "
                + "attribute_0, 0.05, false, false, 2, attribute_0, attribute_1 , "
        ...
        try {
            ...
            AssertJUnit.assertTrue(e instanceof SiddhiAppCreationException);
            AssertJUnit.assertTrue(e.getCause().getMessage().contains("Allowable Split Error must be "
                    + "(ConstantExpressionExecutor) but found io.siddhi.core.executor.VariableExpressionExecutor"
                    + " in position 5"));
        }
    }
    ...
    public void testHoeffdingClassifierLearningExtension18() throws InterruptedException {
        ...
        try {
            ...
            logger.error(e.getCause().getMessage());
            AssertJUnit.assertTrue(e instanceof SiddhiAppCreationException);
            AssertJUnit.assertTrue(e.getCause().getMessage().contains("Option tieThreshold cannot be greater than 1.0, "
                    + "out of range: 2.0"));
        }
    }
