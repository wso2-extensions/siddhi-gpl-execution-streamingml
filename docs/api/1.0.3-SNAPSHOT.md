...
<table>
    ...
    <tr>
        ...
        <td style="vertical-align: top; word-wrap: break-word">Hoeffding Bound Parameter. The allowable error in split decision, values closer to 0 will take longer to decide. min:0 max:1</td>
    ...
    <tr>
        ...
        <td style="vertical-align: top; word-wrap: break-word">Hoeffding Bound Parameter. Threshold below which a split will be forced to break ties. min:0 max:1</td>
